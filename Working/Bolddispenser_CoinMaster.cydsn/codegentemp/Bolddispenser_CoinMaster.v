// ======================================================================
// Bolddispenser_CoinMaster.v generated from TopDesign.cysch
// 12/12/2018 at 20:32
...
// Sample_Hold_v1_40(Power=3, Sample_Clock_Edge=1, Sample_Mode=1, Vdda_Value=5, Vref_Type=1, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=Sample_Hold_v1_40, CY_CONFIG_TITLE=Sample_Hold_1, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Sample_Hold_1, CY_INSTANCE_SHORT_NAME=Sample_Hold_1, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=40, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=Sample_Hold_1, )
...
module ADC_DelSig_v3_30_5 (
	...
	cy_clock_v1_0
		#(.id("30d48bee-c43c-45e0-adf1-1b87eca0761c/b7604721-db56-4477-98c2-8fae77869066"),
	...
	cy_clock_v1_0
		#(.id("30d48bee-c43c-45e0-adf1-1b87eca0761c/edd15f43-b66b-457b-be3a-5342345270c8"),
		  .source_clock_id("61737EF6-3B74-48f9-8B91-F7473A442AE7"),
		  .divisor(0),
		  .period("1443001443.00144"),
		  .is_direct(0),
		  .is_digital(0))
		theACLK
		 (.clock_out(Net_250));
...
module top ;
	...
	wire [0:0] tmpOE__pin_enable_4_net;
	wire [0:0] tmpFB_0__pin_enable_4_net;
	wire [0:0] tmpIO_0__pin_enable_4_net;
	wire [0:0] tmpINTERRUPT_0__pin_enable_4_net;
	electrical [0:0] tmpSIOVREF__pin_enable_4_net;

	cy_psoc3_pins_v1_10
		#(.id("68d40bc2-37d8-4f42-b97a-9350a0992a1b"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		pin_enable_4
		 (.oe(tmpOE__pin_enable_4_net),
		  .y({Net_30}),
		  .fb({tmpFB_0__pin_enable_4_net[0:0]}),
		  .io({tmpIO_0__pin_enable_4_net[0:0]}),
		  .siovref(tmpSIOVREF__pin_enable_4_net),
		  .interrupt({tmpINTERRUPT_0__pin_enable_4_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__pin_enable_4_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__pin_enable_3_net;
	wire [0:0] tmpFB_0__pin_enable_3_net;
	wire [0:0] tmpIO_0__pin_enable_3_net;
	wire [0:0] tmpINTERRUPT_0__pin_enable_3_net;
	electrical [0:0] tmpSIOVREF__pin_enable_3_net;

	cy_psoc3_pins_v1_10
		#(.id("b552b11b-5aab-423a-ad9f-cfe696136cff"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		pin_enable_3
		 (.oe(tmpOE__pin_enable_3_net),
		  .y({Net_1722}),
		  .fb({tmpFB_0__pin_enable_3_net[0:0]}),
		  .io({tmpIO_0__pin_enable_3_net[0:0]}),
		  .siovref(tmpSIOVREF__pin_enable_3_net),
		  .interrupt({tmpINTERRUPT_0__pin_enable_3_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__pin_enable_3_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__pin_enable_1_net;
	wire [0:0] tmpFB_0__pin_enable_1_net;
	wire [0:0] tmpIO_0__pin_enable_1_net;
	wire [0:0] tmpINTERRUPT_0__pin_enable_1_net;
	electrical [0:0] tmpSIOVREF__pin_enable_1_net;

	cy_psoc3_pins_v1_10
		#(.id("dc305d19-58da-46f4-8051-de005eaa8d47"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		pin_enable_1
		 (.oe(tmpOE__pin_enable_1_net),
		  .y({Net_617}),
		  .fb({tmpFB_0__pin_enable_1_net[0:0]}),
		  .io({tmpIO_0__pin_enable_1_net[0:0]}),
		  .siovref(tmpSIOVREF__pin_enable_1_net),
		  .interrupt({tmpINTERRUPT_0__pin_enable_1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__pin_enable_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__pin_enable_2_net;
	wire [0:0] tmpFB_0__pin_enable_2_net;
	wire [0:0] tmpIO_0__pin_enable_2_net;
	wire [0:0] tmpINTERRUPT_0__pin_enable_2_net;
	electrical [0:0] tmpSIOVREF__pin_enable_2_net;

	cy_psoc3_pins_v1_10
		#(.id("1dc7a90b-5769-481f-b6ff-973f7d8b1ea4"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		pin_enable_2
		 (.oe(tmpOE__pin_enable_2_net),
		  .y({Net_762}),
		  .fb({tmpFB_0__pin_enable_2_net[0:0]}),
		  .io({tmpIO_0__pin_enable_2_net[0:0]}),
		  .siovref(tmpSIOVREF__pin_enable_2_net),
		  .interrupt({tmpINTERRUPT_0__pin_enable_2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__pin_enable_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    CyControlReg_v1_80 Motor_Reg_2 (
        .control_1(Net_762),
        .control_2(Net_1722),
        .control_3(Net_30),
        .control_0(Net_617),
        ...
        .clock(1'b0),
        .reset(1'b0));
    defparam Motor_Reg_2.Bit0Mode = 0;
    defparam Motor_Reg_2.Bit1Mode = 0;
    defparam Motor_Reg_2.Bit2Mode = 0;
    defparam Motor_Reg_2.Bit3Mode = 0;
    defparam Motor_Reg_2.Bit4Mode = 0;
    defparam Motor_Reg_2.Bit5Mode = 0;
    defparam Motor_Reg_2.Bit6Mode = 0;
    defparam Motor_Reg_2.Bit7Mode = 0;
    defparam Motor_Reg_2.BitValue = 0;
    defparam Motor_Reg_2.BusDisplay = 0;
    defparam Motor_Reg_2.ExtrReset = 0;
    defparam Motor_Reg_2.NumOutputs = 4;
    ...
    Timer_v2_80_1 Motor_Timer (
        ...
        .tc(Net_240),
        .clock(Net_19));
    defparam Motor_Timer.CaptureCount = 2;
    defparam Motor_Timer.CaptureCounterEnabled = 0;
    defparam Motor_Timer.DeviceFamily = "PSoC5";
    defparam Motor_Timer.InterruptOnCapture = 0;
    defparam Motor_Timer.InterruptOnTC = 0;
    defparam Motor_Timer.Resolution = 8;
    defparam Motor_Timer.SiliconRevision = "0";
	...
	cy_psoc3_pins_v1_10
		#(.id("a201c66b-0089-4349-90ac-85833898d7df"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_clock_v1_0
		#(.id("7f97c3ad-9cf1-44da-8e90-172b5b042033"),
		  .source_clock_id(""),
		  .divisor(0),
    ...
    Timer_v2_80_3 I2C_Timer (
        ...
        .tc(Net_45),
        .clock(Net_39));
    defparam I2C_Timer.CaptureCount = 2;
    defparam I2C_Timer.CaptureCounterEnabled = 0;
    defparam I2C_Timer.DeviceFamily = "PSoC5";
    defparam I2C_Timer.InterruptOnCapture = 0;
    defparam I2C_Timer.InterruptOnTC = 1;
    defparam I2C_Timer.Resolution = 16;
    defparam I2C_Timer.SiliconRevision = "0";
	...
	cy_psoc3_pins_v1_10
		#(.id("373f26db-08e0-4461-a3d3-6c914d7f44aa"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    Sample_Hold_v1_40_4 Sample_Hold_1 (
        .sclk(Net_1306),
        .Vin(Net_472),
        .Vout(Net_473),
        .Vref(Net_46));
	...
	cy_clock_v1_0
		#(.id("ca9bb174-58dc-4858-a8ce-ea90c6aab1f2"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("25000000000"),
		  .is_direct(0),
	...
	wire [0:0] tmpOE__IR_puls_net;
	wire [0:0] tmpFB_0__IR_puls_net;
	wire [0:0] tmpIO_0__IR_puls_net;
	wire [0:0] tmpINTERRUPT_0__IR_puls_net;
	electrical [0:0] tmpSIOVREF__IR_puls_net;

	cy_psoc3_pins_v1_10
		#(.id("86fc192c-7a31-431b-9b98-68eb2c33f873"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		IR_puls
		 (.oe(tmpOE__IR_puls_net),
		  .y({Net_1241}),
		  .fb({tmpFB_0__IR_puls_net[0:0]}),
		  .io({tmpIO_0__IR_puls_net[0:0]}),
		  .siovref(tmpSIOVREF__IR_puls_net),
		  .interrupt({tmpINTERRUPT_0__IR_puls_net[0:0]}),
		  .annotation({Net_207}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__IR_puls_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__pin_full_net;
	wire [0:0] tmpFB_0__pin_full_net;
	wire [0:0] tmpIO_0__pin_full_net;
	wire [0:0] tmpINTERRUPT_0__pin_full_net;
	electrical [0:0] tmpSIOVREF__pin_full_net;

	cy_psoc3_pins_v1_10
		#(.id("4c1fdc76-137e-41f5-ad4e-81c6580d341f"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		pin_full
		 (.oe(tmpOE__pin_full_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__pin_full_net[0:0]}),
		  .io({tmpIO_0__pin_full_net[0:0]}),
		  .siovref(tmpSIOVREF__pin_full_net),
		  .interrupt({tmpINTERRUPT_0__pin_full_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__pin_full_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__pin_empty_net;
	wire [0:0] tmpFB_0__pin_empty_net;
	wire [0:0] tmpIO_0__pin_empty_net;
	wire [0:0] tmpINTERRUPT_0__pin_empty_net;
	electrical [0:0] tmpSIOVREF__pin_empty_net;

	cy_psoc3_pins_v1_10
		#(.id("00d5e4b6-0434-4a96-9ecc-b34ce136fb34"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		pin_empty
		 (.oe(tmpOE__pin_empty_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__pin_empty_net[0:0]}),
		  .io({tmpIO_0__pin_empty_net[0:0]}),
		  .siovref(tmpSIOVREF__pin_empty_net),
		  .interrupt({tmpINTERRUPT_0__pin_empty_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__pin_empty_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__pin_enable_5_net;
	wire [0:0] tmpFB_0__pin_enable_5_net;
	wire [0:0] tmpIO_0__pin_enable_5_net;
	wire [0:0] tmpINTERRUPT_0__pin_enable_5_net;
	electrical [0:0] tmpSIOVREF__pin_enable_5_net;

	cy_psoc3_pins_v1_10
		#(.id("5320f83f-0574-4374-acf5-67a1cd44fe0d"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		pin_enable_5
		 (.oe(tmpOE__pin_enable_5_net),
		  .y({Net_1735}),
		  .fb({tmpFB_0__pin_enable_5_net[0:0]}),
		  .io({tmpIO_0__pin_enable_5_net[0:0]}),
		  .siovref(tmpSIOVREF__pin_enable_5_net),
		  .interrupt({tmpINTERRUPT_0__pin_enable_5_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__pin_enable_5_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__pin_enable_6_net;
	wire [0:0] tmpFB_0__pin_enable_6_net;
	wire [0:0] tmpIO_0__pin_enable_6_net;
	wire [0:0] tmpINTERRUPT_0__pin_enable_6_net;
	electrical [0:0] tmpSIOVREF__pin_enable_6_net;

	cy_psoc3_pins_v1_10
		#(.id("c9c8daf1-4dad-4ce2-b030-232eb651fa6f"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		pin_enable_6
		 (.oe(tmpOE__pin_enable_6_net),
		  .y({Net_1736}),
		  .fb({tmpFB_0__pin_enable_6_net[0:0]}),
		  .io({tmpIO_0__pin_enable_6_net[0:0]}),
		  .siovref(tmpSIOVREF__pin_enable_6_net),
		  .interrupt({tmpINTERRUPT_0__pin_enable_6_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__pin_enable_6_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__pin_enable_8_net;
	wire [0:0] tmpFB_0__pin_enable_8_net;
	wire [0:0] tmpIO_0__pin_enable_8_net;
	wire [0:0] tmpINTERRUPT_0__pin_enable_8_net;
	electrical [0:0] tmpSIOVREF__pin_enable_8_net;

	cy_psoc3_pins_v1_10
		#(.id("1fb36cf5-9ce6-4bf0-90cc-0fe550e8edb1"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		pin_enable_8
		 (.oe(tmpOE__pin_enable_8_net),
		  .y({Net_1737}),
		  .fb({tmpFB_0__pin_enable_8_net[0:0]}),
		  .io({tmpIO_0__pin_enable_8_net[0:0]}),
		  .siovref(tmpSIOVREF__pin_enable_8_net),
		  .interrupt({tmpINTERRUPT_0__pin_enable_8_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__pin_enable_8_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__pin_enable_7_net;
	wire [0:0] tmpFB_0__pin_enable_7_net;
	wire [0:0] tmpIO_0__pin_enable_7_net;
	wire [0:0] tmpINTERRUPT_0__pin_enable_7_net;
	electrical [0:0] tmpSIOVREF__pin_enable_7_net;

	cy_psoc3_pins_v1_10
		#(.id("61a3cc60-e86a-4197-b4db-bd677a0284fb"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		pin_enable_7
		 (.oe(tmpOE__pin_enable_7_net),
		  .y({Net_1738}),
		  .fb({tmpFB_0__pin_enable_7_net[0:0]}),
		  .io({tmpIO_0__pin_enable_7_net[0:0]}),
		  .siovref(tmpSIOVREF__pin_enable_7_net),
		  .interrupt({tmpINTERRUPT_0__pin_enable_7_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__pin_enable_7_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    CyControlReg_v1_80 Motor_Reg_1 (
        .control_1(Net_1738),
        .control_2(Net_1736),
        .control_3(Net_1735),
        .control_0(Net_1737),
        ...
        .clock(1'b0),
        .reset(1'b0));
    defparam Motor_Reg_1.Bit0Mode = 0;
    defparam Motor_Reg_1.Bit1Mode = 0;
    defparam Motor_Reg_1.Bit2Mode = 0;
    defparam Motor_Reg_1.Bit3Mode = 0;
    defparam Motor_Reg_1.Bit4Mode = 0;
    defparam Motor_Reg_1.Bit5Mode = 0;
    defparam Motor_Reg_1.Bit6Mode = 0;
    defparam Motor_Reg_1.Bit7Mode = 0;
    defparam Motor_Reg_1.BitValue = 0;
    defparam Motor_Reg_1.BusDisplay = 0;
    defparam Motor_Reg_1.ExtrReset = 0;
    defparam Motor_Reg_1.NumOutputs = 4;
